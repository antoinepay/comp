...
class IRInstr {
   ...
   public:
	...
	typedef enum {
		...
		div,
		mod,
		neg, // rendre une var/constante negative
		incq, // ++var
		decq, // --var
		cmp,
		cmove, // ==
 ...
 private:
	...
	Operation op;
	Type t;
	vector<string> params; /**< For 3-op instrs: d, x, y; for ldconst: d, c;  For call: label, d, params;  for wmem : d,x and rmem: choose yourself */
...
class BasicBlock {
 public:
	...
	BasicBlock(CFG* cfg, string entry_label,list<Instruction*>* instructions);
...
class CFG {
 public:
	CFG(Definition_fonction* ast);
	CFG();

	Definition_fonction* ast; /**< The AST this CFG comes from */
	...
	void gen_asm_linker_directives(ostream& o);
